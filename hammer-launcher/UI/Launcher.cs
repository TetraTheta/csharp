...
using HammerLauncher.Common.Hammer;
using HammerLauncher.Common.Resource;
using HammerLauncher.Common.WinForm;
...
public partial class Launcher : Form {
  ...
  private void DisableHl2() {
    pictureBoxHL2.Image = RuntimeResource.GameHL2Gray_32;
    buttonHL2Hammer.Enabled = false;
    buttonHL2HammerPP.Enabled = false;
  }

  private void DisableGMod() {
    pictureBoxGMod.Image = RuntimeResource.GameGModGray_32;
